...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("summercoinv2-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("summercoinv2-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SummerCoinV2 " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("summercoinv2-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("summercoinv2-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("summercoinv2-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("summercoinv2-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SummerCoinV2 is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("summercoinv2-start");
